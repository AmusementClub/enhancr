        ...
        if (!(stopped == 'true')) {
            ...
            function getOnnxPath() {
                if (engine == 'Restoration - DPIR (TensorRT)' && model == 'Denoise') {
                    return path.join(__dirname, '..', "/python/env/vapoursynth64/plugins/models/dpir/drunet_color.onnx");
                } else if (engine == 'Restoration - DPIR (TensorRT)' && model == 'Deblock') {
                    return path.join(__dirname, '..', "/python/env/vapoursynth64/plugins/models/dpir/drunet_deblocking_color.onnx")
